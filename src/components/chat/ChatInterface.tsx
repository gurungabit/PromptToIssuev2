        ...
        <div className="chat-header px-8 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="text-sm">
              <p className="font-medium text-foreground">Welcome back, {user?.fullName || user?.username}</p>
                  ...
                  <div className="absolute -top-12 left-0 right-0 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className={cn(
                        ...
                        currentMode === 'ticket' ? "text-foreground font-bold text-green-500" : "text-muted-foreground"
                      )}>
                        Tickets
                      </span>
                      ...
                      <span className={cn(
                        "font-medium transition-colors",
                        currentMode === 'assistant' ? "text-foreground font-bold text-blue-500" : "text-muted-foreground"
                      )}>
                        Assistant
                      </span>
                    </div>
